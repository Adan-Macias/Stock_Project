...
def QE_API(yourStock):
    stockURL = 'https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol='+yourStock+'&apikey=YOUR API KEY0'
...
def Time_Series_Monthly():
    ...
    dataToExcel = pd.ExcelWriter("YOUR PATH/Stock_YTS.xlsx", engine='xlsxwriter')
...
def QEndpoint():
    ...
    dataToExcel = pd.ExcelWriter("YOUR PATH/Stock_Global.xlsx", engine='xlsxwriter')
